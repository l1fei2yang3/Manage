...
class TBook(models.Model):
    ...
    pics = models.ImageField(upload_to='pics',null=True)
    book_publish = models.CharField(max_length=20, blank=True, null=True)
    ...
    book_paper = models.CharField(max_length=10, blank=True, null=True)
    book_wrapper = models.CharField(max_length=10, blank=True, null=True)
...
class TConfirmString(models.Model):
    ...
    user_id = models.ForeignKey('TUser', models.DO_NOTHING, blank=True, null=True)
